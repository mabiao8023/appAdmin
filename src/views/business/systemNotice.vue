<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="el-icon-edit">新增系统消息</el-button>
    </div>
...
<script>
  import { fetchList, fetchNotice, createNotice, updateNotice, deleteNotice } from '@/api/systemNotice'
