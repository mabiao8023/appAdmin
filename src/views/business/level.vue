...
<template>
    <div class="app-container calendar-list-container">
        <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
            ...
            <el-table-column width="150px" align="center" label="会员类型">
                <template slot-scope="scope">
                    <span>{{scope.row.type ? '分析师' : '普通用户'}}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column min-width="100px" align="center" label="等级图标">
                <template slot-scope="scope">
                    <img :src="scope.row.icon"  style="width:60px;">
                </template>
            </el-table-column>
            <el-table-column min-width="200px" align="center" label="免费查看（发推荐）单数">
                <template slot-scope="scope">
...
<script>
    import {fetchList, updateLevel} from '@/api/level'
