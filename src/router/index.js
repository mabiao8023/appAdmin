...
export const asyncRouterMap = [
    {
        ...
        children: [
            ...
            {
                path: 'analystsMember',
                component: _import('business/analystsMember'),
                name: '分析师等级配置',
                meta: {title: '分析师等级配置'}
            },
            {
    ...
    // },
    {
        ...
        children: [
            ...
            {
                path: 'analystApplication',
                component: _import('users/analystApplication'),
                name: '分析师申请',
                meta: {title: '分析师申请'}
            },
        ]
...

    {
        ...
        children: [
            ...
            {
                path: 'videoList/:id',
                component: _import('video/videoList'),
                name: '视频列表',
                meta: {title: '视频列表'},
                hidden: true
            },
            {
                path: 'videoCateList/:id',
                component: _import('video/videoCateList'),
                name: '分类视频列表',
                meta: {title: '分类视频列表'},
                hidden: true
            },
